...
static int vdd_gx_corner[] = {
	RPM_REGULATOR_LEVEL_MIN_SVS,		/* VDD_GX_MIN */
	RPM_REGULATOR_LEVEL_SVS,		/* VDD_GX_LOW */
	RPM_REGULATOR_LEVEL_SVS_PLUS,		/* VDD_GX_LOW_L1 */
	RPM_REGULATOR_LEVEL_NOM,		/* VDD_GX_NOMINAL */
	RPM_REGULATOR_LEVEL_NOM_PLUS,		/* VDD_GX_NOMINAL_L1 */
	RPM_REGULATOR_LEVEL_TURBO,		/* VDD_GX_HIGH */
};
